...
const messages: Record<Locale, any> = {
  en: {
    ...
    games: {
      ...
      hangman: { name: 'Hangman', desc: 'Gjett ordet før det er for sent' },
      hangman: { name: 'Hirsipuu', desc: 'Arvaa sana ennen kuin on liian myöhäistä' },
      hangman: { name: 'Galge mand', desc: 'Gæt ordet, før det er for sent' },
      hangman: { name: 'Hangman', desc: 'เดาคำก่อนจะสายเกินไป' },
      hangman: { name: 'Ngưới Treo Cổ', desc: 'Đoán từ trước khi quá muộn' },
      hangman: { name: 'Hangman', desc: 'Tebak kata sebelum terlambat' },
      hangman: { name: 'Akasztófa', desc: 'Találd ki a szót, mielőtt túl késő lenne' },
      hangman: { name: 'Hänga gubbe', desc: 'Gissa ordet innan det är för sent' },
      hangman: { name: 'Šibenice', desc: 'Hádejte slovo, dokud není pozdě' },
      hangman: { name: 'Κρεμασμένος', desc: 'Μαντέψτε τη λέξη πριν να είναι αργά' },
      hangman: { name: 'Spânzurătoarea', desc: 'Ghicește cuvântul înainte să fie prea târziu' },
      hangman: { name: 'Шибениця', desc: 'Вгадайте слово, поки не пізно' },
      hangman: { name: 'Galgje', desc: 'Raad het woord voordat het te laat is' },
      hangman: { name: 'Wisielec', desc: 'Odgadnij słowo, zanim będzie za późno' },
      hangman: { name: 'Impiccato', desc: 'Indovina la parola prima che sia troppo tardi' },
      hangman: { name: 'Adam Asmaca', desc: 'Çok geç olmadan kelimeyi tahmin et' },
      hangman: { name: 'Pendu', desc: 'Devinez le mot avant qu il ne soit trop tard' },
      hangman: { name: '행맨', desc: '늦기 전에 단어를 맞춰보세요' },
      hangman: { name: 'Galgenmännchen', desc: 'Errate das Wort, bevor es zu spät ist' },
      hangman: { name: 'ハングマン', desc: '手遅れになる前に単語を当てて' },
      hangman: { name: 'Виселица', desc: 'Угадайте слово, пока не поздно' },
      hangman: { name: 'হ্যাংম্যান', desc: 'বিলম্ব হওয়ার আগে শব্দটি অনুমান করুন' },
      hangman: { name: 'Forca', desc: 'Adivinhe a palavra antes que seja tarde' },
      hangman: { name: 'फांसी', desc: 'देर होने से पहले शब्द का अनुमान लगाएं' },
      hangman: { name: '吊死人', desc: '在为时已晚之前猜出单词' },
      hangman: { name: 'Ahorcado', desc: 'Adivina la palabra antes de que sea tarde' },
      hangman: { name: 'Hangman', desc: 'Guess the word before it is too late' },
